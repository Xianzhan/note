package xianzhan.frame.spring.base.config.aop;
...
public class CAspect {
    ...
    @Pointcut("execution(* xianzhan.frame.spring.base.bean.IC.around(..))")
    public void pointCutAround() {

    }

    @Pointcut("execution(* xianzhan.frame.spring.base.bean.IC.before(..))")
    public void pointCutBefore() {

    }

    @Pointcut("execution(* xianzhan.frame.spring.base.bean.IC.after(..))")
    public void pointCutAfter() {

    }

    @Pointcut("execution(* xianzhan.frame.spring.base.bean.IC.afterReturning(..))")
    public void pointCutAfterReturning() {

    }

    @Pointcut("execution(* xianzhan.frame.spring.base.bean.IC.afterThrowing(..))")
